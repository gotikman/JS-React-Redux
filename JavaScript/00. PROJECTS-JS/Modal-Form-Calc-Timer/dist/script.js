...
/***/ "./src/js/modules/calcWidthScroll.js":
/*!*******************************************!*\
  !*** ./src/js/modules/calcWidthScroll.js ***!
  \*******************************************/
...
function calcWidthScroll() {
  ...
  var scrollWidth = div.offsetHeight - div.clientWidth; //? ширина прокрутки

  div.remove();
  return scrollWidth;
}

/* harmony default export */ __webpack_exports__["default"] = (calcWidthScroll);
...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
 ...
 //! функція записує в стайт усі дані вибрані користувачем у формах
//! Далі ці дані передадуться на сервер як FormData
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#width'); //* вілідація, тільки цифри

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); //* вілідація, тільки цифри
  //! універсальна фун. для запису даних в state
          ...
          case 'INPUT':
            if (item.getAttribute('type') === 'checkbox') {
              ...
              elem.forEach(function (box, j) {
                //! галочка тільки на 1 з чекбоксів
                box.checked = false;
...
var checkNumInputs = function checkNumInputs(selector) {
  var namInputs = document.querySelectorAll(selector); //! Валідація поля, ввід тільки цифри

  namInputs.forEach(function (item) {
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      ...
      windows = document.querySelectorAll('[data-modal]'); //! Валідація поля номеру, ввід тільки цифри

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]'); //! Обєкт повідомлень користувачу
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //! можна зробити тег img і залежно від статусу міняти адреса атрибута href з обєкта message

      var statusMessage = document.createElement('div'); // блок статусу відправки

      statusMessage.classList.add('status');
      item.appendChild(statusMessage);
      var formData = new FormData(item); //* збираєм дані з форми стандартної

      if (item.getAttribute('data-calc') === "end") {
        //* добавляєм дані з інших форм (state)
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _calcWidthScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./calcWidthScroll */ "./src/js/modules/calcWidthScroll.js");
 //* ширина скролу  
...
var images = function images() {
  var imgPopup = document.createElement('div'),
      ...
      scroll = Object(_calcWidthScroll__WEBPACK_IMPORTED_MODULE_0__["default"])(); //* ширина скролу

  imgPopup.classList.add('popup');
  imgPopup.appendChild(bigImage);
  workSection.appendChild(imgPopup); //!CSS Style 
  ...
  workSection.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target; //! відкриваєм якщо клік по картинці, делегування

    if (target && target.classList.contains('preview')) {
      // перевіряєм клік по картинці    
      var path = target.parentNode.getAttribute('href'); // шлях до великої картинки

      imgPopup.style.display = 'flex';
      bigImage.setAttribute('src', path);
      document.body.style.overflow = "hidden";
      document.body.style.marginRight = "".concat(scroll, "px"); //* ширина скролу +
...
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _calcWidthScroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./calcWidthScroll */ "./src/js/modules/calcWidthScroll.js");
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scroll = Object(_calcWidthScroll__WEBPACK_IMPORTED_MODULE_1__["default"])(); //* ширина скролу
    ...
    close.addEventListener('click', function () {
      ...
      document.body.style.overflow = ""; // document.body.classList.remove('modal-open')      // або включаєм фон, видаливши клас що блокував
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal && closeClickOverlay) {
        // Overlay - перевірка потрібно так закривати
        windows.forEach(function (item) {
          // закриваєм Усі модальні вікна
          item.style.display = 'none';
        });
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  hideTabContent();
  showTabContent(); //!Батьківський елемент що містить таби, делегуєм вміст

  header.addEventListener('click', function (e) {
    var target = e.target; // провіряєм на вміст потрібного селектора в клік. елементі
...
var timer = function timer(id, deadline) {
  ...
  var setClock = function setClock(selector, endtime) {
    //! fn міняє час на сторінці
    var timer = document.querySelector(selector),
        days = timer.querySelector('#days'),
        hours = timer.querySelector('#hours'),
        minutes = timer.querySelector('#minutes'),
        seconds = timer.querySelector('#seconds'),
        timeInterval = setInterval(updateClock, 1000); //запускаєм одразу, тому що затримка 1 сек інтервалом
    ...
    function updateClock() {
      ...
      seconds.textContent = addZero(t.seconds); // обнуляєм лічильник якщо вийшов час
