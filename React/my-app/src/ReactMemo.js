...
//     return prevProps.mail.name === nextProps.mail.name   //повертає true/false
// }
    ...
    return (
        <Container>
            <form className="w-50 border mt-5 p-3 m-auto">
                <div className="mb-3">
                    <label htmlFor="exampleFormControlInput1" className="form-label mt-3">Email \ Reac.memo</label>
